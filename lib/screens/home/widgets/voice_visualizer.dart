        ...
        if (isListening)
          SizedBox(
            ...
            child: Row(
              ...
              children: List.generate(20, (index) => _VoiceWaveBar(delay: index * 50)),
            ),
          )
        else
...
class _VoiceWaveBar extends StatefulWidget {
  final int delay;
  const _VoiceWaveBar({required this.delay});
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            color: AppTheme.cyanAccent.withOpacity(0.5 + (_animation.value * 0.5)),
